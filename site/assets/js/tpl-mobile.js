...
(function () {
  ...
  function initDrawer() {
    ...
    var groups = Array.prototype.slice.call(document.querySelectorAll('.tpl-mega-menu > div'))
    ...
    drawer.innerHTML = '' +
      ...
      '<div class="tpl-drawer-body">' +
        '<div class="tpl-drawer-eyebrow" style="padding-top:18px">Where we treat</div>' +
        '<a class="tpl-drawer-link" href="' + href('01 — face protocols', 'index.html#face') + '"><span>Face</span><span class="idx">01</span></a>' +
        '<a class="tpl-drawer-link" href="' + href('02 — hair restoration', 'index.html#hair') + '"><span>Hair</span><span class="idx">02</span></a>' +
        '<a class="tpl-drawer-link" href="' + href('03 — body quality', 'index.html#body') + '"><span>Body</span><span class="idx">03</span></a>' +

        (groupsHtml ? '<div class="tpl-drawer-eyebrow">All treatments</div>' + groupsHtml : '') +

        '<div class="tpl-drawer-eyebrow">The clinic</div>' +
        '<a class="tpl-drawer-link tpl-drawer-link--gold" href="' + href('services index', 'services.html') + '">Services index</a>' +
        '<a class="tpl-drawer-link" href="' + href('prp — the signature', 'prp.html') + '">PRP — the signature</a>' +
        '<a class="tpl-drawer-link" href="' + href('sofwave™ lifting', 'sofwave.html') + '">Sofwave™ lifting</a>' +
